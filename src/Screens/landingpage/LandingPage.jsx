        ...
        <section class="page-section" id="services">
            <div class="container">
                ...
                <div class="row text-center justify-content-center">
                    ...
                    <div class="col-md-3 services-card mx-4">
                    <img height="150" width="200" className='mt-4 service-img 's src="https://th.bing.com/th/id/OIP.BC8t675Y38a3OksKr4QGhgHaEw?pid=ImgDet&rs=1"/>
                    ...
                    <img height="150" width="200" className='mt-4 service-img 's src="https://th.bing.com/th/id/R.af7866e3963b2d310487a022aead459b?rik=a6rGZBw1AicdDA&pid=ImgRaw&r=0"/>
                    ...
                    <div class="col-md-3 mt-5  services-card mx-4">
                    <img height="150" width="200" className='mt-4 service-img 's src="https://th.bing.com/th/id/R.5c05f327eb37f4c1f141ae6a2aa00240?rik=lDud3dFpbPb6yQ&pid=ImgRaw&r=0"/>
...
<section class="page-section" id="about">
            <div class="container">
                ...
                <ul class="timeline">
                    <li>
                        <div class="timeline-image"><img class="rounded-circle img-fluid" src={imag1} alt="..." /></div>
                    ...
                    <li class="timeline-inverted">
                        <div class="timeline-image"><img class="rounded-circle img-fluid" src={imag2} alt="..." /></div>
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>March 2011</h4>
                    ...
                    <li>
                        <div class="timeline-image"><img class="rounded-circle img-fluid" src={imag3} alt="..." /></div>
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>December 2015</h4>
                    ...
                    <li class="timeline-inverted">
                        <div class="timeline-image"><img class="rounded-circle img-fluid" src={imag4} alt="..." /></div>
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>July 2020</h4>
